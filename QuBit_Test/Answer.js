...
// we pass 2 arguments: the selectorObject and element
  function isCorrect(selectorObject, element) { // element return {tagName: "DIV"}
    // console.log('element', element);
    // console.log('const all and selectorObject are the same!', selectorObject);
    var filters = Object.keys(lardhouse); // this return ["tagName"]
  ...
  function sortElementsTocorrectCategory(array, selectorObject) {
  ...
  console.log('mama', sortElementsTocorrectCategory());
